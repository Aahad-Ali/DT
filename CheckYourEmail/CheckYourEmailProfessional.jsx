...
const CheckYourEmailProfessional = () => {
              ...
              <div className="row">
                <div className="col-md-12">
                  <p className="custom-text-style">
                    ...
                    your email address olivi******@gmail.com
                  </p>
                </div>
              </div>
              <div className="row mt-5">
                <div className="col-md-12">
                  <div className="sign-up-buttons d-flex gap-4">
                    <button
                      onClick={() => navigate("/service-professional-sign-in")}
...
export default CheckYourEmailProfessional;
