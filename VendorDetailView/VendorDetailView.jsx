...
import { Tabs, Table, ConfigProvider, Avatar } from "antd";
...
const VendorDetailView = () => {
  ...
  const { fetchVendorId, VendorData } = UseGetHook("vendor", id);
  const { FetchVendorNotes, NoteData } = UseGetHook("notes", id);
  const { FetchVendorFiles, fileData } = UseGetHook("files", id);
  useEffect(() => {
    fetchVendorId();
    FetchVendorNotes();
    FetchVendorFiles();
  ...
  useEffect(() => {
    fetch(`${config["baseUrl"]}/api/vendor/${id}`, {
      method: "GET",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
    })
      .then((res) => {
            ...
            <TabPane tab="Overview" key="1">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.address_line_1)}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.address_line_2)}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.city?.name)}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.country?.name)}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.state?.name)}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {Data.map((e) => e?.address?.zipcode?.number)}
                        </p>
                      </div>
                    </div>
              ...
              <div className="row my-5">
                <div className="col-md-12">
                  ...
                  <div className="task-info-lists"></div>
                </div>
              </div>
              <hr />
              <div className="row my-5">
                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <p>
                          ...
                          {VendorData[0]?.insurance?.provider}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {new Date(VendorData[0]?.insurance?.effective_date).toLocaleDateString()}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {new Date(VendorData[0]?.insurance?.expiration_date).toLocaleDateString()}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {VendorData[0]?.insurance?.policy_number}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p>
                          ...
                          {VendorData[0]?.insurance?.coverage}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="row mt-4">
                      <div className="col-md-12">
                        <div className="notes-btn d-flex align-items-center justify-content-center gap-3">
                          ...
                          <button className="save-btn" onClick={addVendorNotes}>
                            Save
                          </button>
                        </div>
                      </div>
